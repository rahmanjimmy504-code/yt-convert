          ...
          <div className="flex items-center gap-3 cursor-pointer select-none" onClick={handleReset}>
            <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-gradient-to-br from-red-500 to-red-600 shadow-lg shadow-red-500/20">
              {/* Brand mark: a bold download arrow — the YT Convert logo.
                  Matches the favicon (src/app/icon.tsx) and the OG/Twitter
                  share card (src/lib/og-card.tsx) for a consistent identity.
                  The YouTube-style glyph now lives only on the YouTube tile
                  in the "Supported Platforms" grid below. */}
