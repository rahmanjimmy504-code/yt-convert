...
- YT Convert converts where it legally and technically can: Download here extracts a public stream (YouTube/YT Music via Innertube + Invidious, SoundCloud progressive, public X/TikTok/Instagram/Facebook URLs) and proxies it. Files are never stored. DRM catalogs (Spotify, Deezer, Apple Music, Amazon Music) are not ripped — preview only / use a licensed downloader. Snapchat and BeReal have no public media URL. Third-party converter cards are the fallback when extraction fails. Do not claim every converter receives the URL automatically. AUTO-SEND = verified deep link/form. COPY NEEDED = honest copy step.
