 ...
 *
 * Adapted from the YT Convert website (src/lib/android-download-apps.ts), dual-licensed by its
 * copyright holder under the GNU General Public License v3 or later for this
 * repository.
 *
